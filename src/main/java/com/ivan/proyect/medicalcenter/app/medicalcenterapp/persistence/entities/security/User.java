package com.ivan.proyect.medicalcenter.app.medicalcenterapp.persistence.entities.security;
...
public class User {
    ...
    public User(@NotBlank @Size(min = 4, max = 12) String username, @NotBlank String password,
